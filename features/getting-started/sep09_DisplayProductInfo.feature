...
@sep09-1
    Scenario: Product information
        Then user see Product name Test Automation with Selenium is displayed
        Then user see Product name matches Program name
        Then user see Product price is displayed
        And user see flexible payment option is displayed
        And user see flexible Program start date is displayed
        And user see final date for refund is displayed